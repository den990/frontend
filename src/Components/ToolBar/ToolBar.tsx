        ...
        <div className={style.toolbar}>
            ...
            <div className={style.toolbar__blockFunctions}>
                ...
                <select placeholder={"Выберите шрифт"} className={style.toolbar__blockFunction__editFontFamily}
                        onChange={(event) => {
                            editFontFamilyHandler(Props.presentation.slideList[(Props.presentation.selectedSlides[0].slideIndex) - 1].slideIndex, Props.presentation.slideList[(Props.presentation.selectedSlides[0].slideIndex) - 1].selectedBlockList[0].blockIndex, event.target.value)
                        }}>
                    <option value={"Arial"} className={style.toolbar__blockFunction__editFontFamily_Arial}>Arial
                    </option>
                    <option value={"Times New Roman"}
                            className={style.toolbar__blockFunction__editFontFamily_TimesNewRoman}>Times New Roman
                    </option>
                    <option value={"Medium Montserrat"}
                            className={style.toolbar__blockFunction__editFontFamily_Montserrat}>Montserrat
                    </option>
                    <option value={"Roboto"} className={style.toolbar__blockFunction__editFontFamily_Roboto}>Roboto
                    </option>
                    <option value={"Tahoma"} className={style.toolbar__blockFunction__editFontFamily_Tahoma}>Tahoma
                    </option>
                </select>
                <button
                    onClick={decrement}
